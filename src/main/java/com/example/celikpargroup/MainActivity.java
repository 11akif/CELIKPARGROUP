                        ...
                        try {
                            ...
                            if (jsonObject.getBoolean("success")) {
                                ...
                                if (dataArray.length() > 0) {
                                    ...
                                    // Add followed customer to list and update adapter
                                    FollowedCustomer followedCustomer = new FollowedCustomer(phoneNumber, trackingCode);
                                    followedCustomers.add(followedCustomer);
